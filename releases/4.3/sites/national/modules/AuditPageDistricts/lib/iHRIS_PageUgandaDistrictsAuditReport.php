...
class iHRIS_PageUgandaDistrictsAuditReport extends I2CE_Page {
    ...
    protected function action_display( $district=null ) {
	    ...
	    $db = I2CE::PDO();
      //  $qry = "(SELECT `job+title` AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' ORDER BY `facility+name`, `salary_grade+id`, `job+title`) UNION (SELECT `job+title` AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm_ii_iii` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' ORDER BY `facility+name`, `salary_grade+id`, `job+title`) UNION (SELECT `job+title` AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm_moh` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' ORDER BY `facility+name`, `salary_grade+id`, `job+title`) UNION (SELECT `job+title` AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm_other` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' ORDER BY `facility+name`, `salary_grade+id`, `job+title`)" ;


$qry1 = "SELECT DISTINCT(`job+title`) AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' GROUP BY `facility+id`,`job+title` ORDER BY `facility+name`, `salary_grade+id`, `job+title`" ;

$qry2 = "SELECT DISTINCT(`job+title`) AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm_ii_iii` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' GROUP BY `facility+id`,`job+title` ORDER BY `facility+name`, `salary_grade+id`, `job+title`" ;

$qry3 = "SELECT DISTINCT(`job+title`) AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm_moh` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' GROUP BY `facility+id`,`job+title` ORDER BY `facility+name`, `salary_grade+id`, `job+title`" ;

$qry4 = "SELECT DISTINCT(`job+title`) AS title, `salary_grade+name` AS salary_grade,`facility+id` AS facility, `facility+name` AS facility_name, `primary_form+amount` AS amount , `+filled_positions` AS filled_positions , `+variance` AS variance, `+percentage_filled` AS percentage_filled FROM `zebra_staff_norm_other` WHERE `district+id` = '" . I2CE_PDO::escape_string( $district ) . "' GROUP BY `facility+id`,`job+title` ORDER BY `facility+name`, `salary_grade+id`, `job+title`" ;

$query = [$qry1,$qry2,$qry3,$qry4];
