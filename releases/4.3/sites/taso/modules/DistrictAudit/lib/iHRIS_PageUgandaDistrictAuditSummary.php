 ...
 * @access public
 */
class iHRIS_PageUgandaDistrictAuditSummary extends I2CE_Page {
    ...
    protected function action() {
        parent::action();
        $this->template->setAttribute( "class", "active", "menuAuditPage", "a[@href='audit_district_report']" );
    ...
    protected function actionCommandLine( $args, $request_remainder ) {
        ...
        $this->template->addFile( "audit_district_report_base.html" );
              ...
              //  if ( $data->facility != $last_facility ) {
                 /*   if ( $last_facility != 'NOTSET' ) {
		            ...
		            /*if ($data->amount == 0 && $data->filled_positions == 0  ){
                        ...
                        $establishmentNode = $this->template->appendFileById( "audit_report_job_establishment.html","tr", 
