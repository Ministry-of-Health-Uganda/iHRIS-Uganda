...
class I2CE_CustomReport_Display_CrossTab extends I2CE_CustomReport_Display_Default
{
    ...
    {
        if (
            array_key_exists('CrossTab_export', $this->defaultOptions)
    ...
    {
        if (
            array_key_exists('CrossTab_percentage', $this->defaultOptions)
    ...
    /**
     * Generate the data for this crosstab and return it.
    ...
    public function generateExport($contentNode, $return_array = true)
    {
        if ($this->isExport()) {
            ...
            I2CE::raiseError("Tried to call generatewhen isn't set for this report.");
            return '';
        }
    }
